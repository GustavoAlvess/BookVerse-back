   ...
   const membroEquipe13 = await prisma.equipe.create({
    ...
    const livro = await prisma.livro.create({
        data: {
            ...
            enredo_pt: 'O Ciclo da Sobrevivência em Vidas Secas. O livro Vidas Secas, escrito por Graciliano Ramos, conta a história de uma família muito pobre que vive no sertão nordestino. Eles sofrem demais com a seca, a fome e a falta de oportunidades para mudar de vida. A família é formada por Fabiano, Sinhá Vitória, os dois filhos (que nem nome têm no livro) e a cachorra Baleia. Juntos, eles passam por muita coisa para conseguir sobreviver em um lugar tão duro e castigado. No começo da história, a gente vê a família andando pelo sertão, fugindo da seca e procurando um lugar para morar. Depois de caminhar muito e quase morrer de cansaço, eles encontram uma fazenda abandonada e resolvem ficar por ali. O Fabiano consegue emprego como vaqueiro e a Sinhá Vitória cuida da casa. Ela tem o sonho de ter uma cama de couro de verdade, o que mostra como as coisas mais simples eram difíceis para eles. Só que, mesmo com emprego, a vida deles não fica fácil. O Fabiano é muito explorado pelo patrão e sofre várias injustiças, como quando vai para a cidade e acaba preso por um soldado sem ter feito nada errado. Outro ponto importante é que, como eles não tiveram estudo, têm muita dificuldade para conversar e expressar o que sentem. Os filhos crescem nesse ambiente limitado, sem chance de ir para a escola ou ter um futuro melhor. Um dos momentos mais tristes do livro é a morte da cachorra Baleia. Ela é tratada como se fosse gente da família e é super apegada a todo mundo. Quando ela fica doente e morre, a tristeza é enorme e mostra bem como a vida deles era cheia de perdas. No final, a seca volta com tudo e castiga a região de novo. Sem água e sem comida, eles são obrigados a arrumar as malas e ir embora para outra terra. O livro termina do mesmo jeito que começou: com a família caminhando sem rumo. Isso mostra que a vida do retirante é um ciclo que se repete sempre. No fim das contas, Vidas Secas é uma grande crítica social que mostra a luta real de muita gente contra a pobreza e o abandono no Nordeste.',
            enredo_en: "The Cycle of Survival in Dry Lives The book Vidas Secas, written by Graciliano Ramos, tells the story of a very poor family that lives in the northeastern hinterland. They suffer too much from drought, hunger and lack of opportunities to change their lives. The family is made up of Fabiano, Sinhá Vitória, the two children (who don't even have a name in the book) and the dog Baleia. Together, they go through a lot to survive in such a hard and punished place. At the beginning of the story, we see the family walking through the hinterland, fleeing the drought and looking for a place to live. After walking a lot and almost dying of fatigue, they find an abandoned farm and decide to stay there. Fabiano gets a job as a cowboy and Sinhá Vitória takes care of the house. She has the dream of having a real leather bed, which shows how the simplest things were difficult for them. But, even with a job, their life is not easy. Fabiano is very exploited by the boss and suffers several injustices, such as when he goes to the city and ends up arrested by a soldier without having done anything wrong. Another important point is that, since they didn't study, they have a lot of difficulty talking and expressing what they feel. Children grow up in this limited environment, with no chance to go to school or have a better future. One of the saddest moments of the book is the death of the dog Baleia. She is treated as if she were family members and is super attached to everyone. When she gets sick and dies, the sadness is enormous and shows well how their lives were full of losses. In the end, the drought comes back with everything and punishes the region again. Without water and food, they are forced to pack their bags and leave for another land. The book ends the same way it started: with the family walking aimlessly. This shows that the life of the retiree is a cycle that repeats itself again and again. In the end, Vidas Secas is a great social criticism that shows the real struggle of many people against poverty and abandonment in the Northeast.",
            ...
            video_url: 'https://www.youtube.com/embed/GZ9kFbRt5mE',
